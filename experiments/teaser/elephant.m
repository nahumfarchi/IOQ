...
ANGLEs          = {'-0.020046,-0.958322,-0.276379,0.0695078',...; % front
                   '-0.0852539,0.0403384,-0.00345443,0.995536',... % front2
                   }; 
angle_names = {'front','front2'};               
CAMERA_ZOOMs   = [1.76024, 1.91174];
FONT_SIZE      = 14;
SAVE_TITLE     = true;
CLOSE          = true;
