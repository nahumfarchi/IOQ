...
switch meshname
    case "phands_r"
        ...
        cam.cp = [0.358268 0.805452 -7.692446 ];
    otherwise
        cam = [];
end
...
figure
subplot(221); res_ioq_conn.draw(props{:})    ; title(title1);
subplot(222); res_miq.draw(props{:})         ; title(title3) ; 
subplot(223); res_ioq_conn_f.draw(props{:})  ; title(title4) ; 
subplot(224); res_miq_flipped.draw(props{:}) ; title(title6) ; 
