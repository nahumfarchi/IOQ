...
title_miq = {'MIQ', sprintf('$E = %g, |S| = %d$',             res_miq.miq_energy,        res_miq.n_vert_sing)};
...
title_miq_f = {'MIQ', sprintf('$E = %g, |S| = %d$',           res_miq_flipped.miq_energy, res_miq_flipped.n_vert_sing)};
...
subplot(222); res_miq.draw(props{:})         ; title(title_miq) ; 
subplot(223); res_ioq_conn_f.draw(props{:})  ; title(title_ioqe_f) ; 
subplot(224); res_miq_flipped.draw(props{:}) ; title(title_miq_f) ;
