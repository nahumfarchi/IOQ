...
%experiment_name = 'ashish_nob_small_02';

%experiment_name = 'yeah_right';
%experiment_name = 'bunnies';
%experiment_name = 'ashish_nob_small';
%data_folder = '../../../data/ashish_nob_small/';

%data_folder = fullfile('..', '..', '..', 'data', experiment_name);

%experiment_name  = 'genus1_small_02';
%data_folder = '../../../data/genus1_small/';

%experiment_name = 'bunnyBotsch_multires_02';
%data_folder = '../../../data/multires/multires/bunnyBotsch_multires/';
